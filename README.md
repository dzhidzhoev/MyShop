...
В параметрах тестов нужно указывать название БД для запуска функциональных тестов, в параметрах приложения - название 
...
## Функционирование
Код использует Spring и Spring Data. Функциональные тесты написаны с помощью фреймворка TestNG. 
